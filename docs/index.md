...
<center><img src="figs/CIBUSmod overview.png", style="width: 90%; max-width: 800px"></center>
...
!!! abstract "**Key papers**"
    <a href="https://doi.org/10.5194/gmd-18-8589-2025" target="_blank" rel="noopener">
    Karlsson, J.O., Karlsson-Potter, H., Lagnelöv, O., Ericsson, N., Einarsson, R. & Hansson, P.A. (2025). CIBUSmod 25.09: a spatially disaggregated biophysical agri-food systems model for studying national-level demand- and production-side intervention scenarios. Geosci. Model Dev., 18(22), 8589-8611.
    </a>
...
Gurobi is the back-end solver used in CIBUSmod to solve the convex optimisation problem involved in regionally distributing crops and animals. This is a commercial software and therefore require a license to run, but free academic licenses are provided. 
...
- Go to: https://portal.gurobi.com/iam/licenses/request/?type=academic
  and generate a “Named-User Academic” license. You must be connected to the internet via your university (VPN should work). Copy the grbgetkey line you receive and keep it.
- Get the license manager “grbgetkey” from here: https://support.gurobi.com/hc/en-us/articles/360059842732-How-do-I-set-up-a-license-without-installing-the-full-Gurobi-package
- Unpack the “grbgetkey.exe” file in any folder. Open the command prompt and go to that folder. Copy and run the grbgetkey command you got earlier. You should now see some messages and get to decide where to put the license file.
...
<img src="figs/manual/default_data_example1.png"><br>
...
<img src="figs/manual/default_data_ref_csv.png"><br>
...
<img src="figs/manual/default_data_csv_par.png"><br>
...
<img src="figs/manual/default_data_csv_filter.png"><br>
...
<img src="figs/manual/scenario_data_example1.png"><br>
...
<img src="figs/manual/session_repr_example1.png"><br>
*Example of displaying a `Session` object in a jupyter notebook*
...
Each module is described in more detail in the [Modules](modules/index.md) section of this documentation. Additional information can also be obtained by writing the module name followed by a question mark in a Jupyter notebook cell.
